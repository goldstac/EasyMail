...
class _Easymail:
    ...
    def credentials(self, client_secret_file, token_file="token.json"):
        """Authenticate Gmail API using client secret and save token."""
    ...
    class SendMail:
        ...
        def __call__(self, body):
            """Send email; body can be string or f-string with variables."""
...
# Module-level instance for easy syntax
easymail = _Easymail()
